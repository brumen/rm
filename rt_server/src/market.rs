...
pub trait MarketTypeT {
    ...
    fn new(market_name: String, mp: Self::MP) -> Arc<dyn MarketTypeT<MP=Self::MP> + Send + Sync> where Self: Sized + Send + Sync;
    ...
    fn try_from_ref(market_name: String, value: &BorrowedMessage, mp: Self::MP) -> Result<Arc<dyn MarketTypeT<MP=Self::MP> + Send + Sync>, MarketTypeError> where Self:Sized + Send + Sync;
